...
// import io.smallrye.mutiny.Uni; // Plus besoin
...
public interface LLMService {
    ...
    String teach(String concept); // <-- Retour direct String
    ...
    String translate(String text); // <-- Retour direct String
    ...
    String summarize(String content); // <-- Retour direct String
}